...
| [ADR-044](ADR-044-p2p-audience-delivery-boundary.md) | P2P audience delivery boundary | Proposed (D1 resolved 2026-09-05 as `O3 parallel`; remaining decisions and acceptance block P2; does not replace ADR-032) |
