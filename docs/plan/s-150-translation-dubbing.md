...
| T2c-iv-a | Retire the legacy SubtitleJob payload contract | development | 40 / M Moderate | Contract cutover implemented 2026-08-13 (two-file `jobs` scope; Gemma phase-2 PASS); worker producer/runtime integration remains separately sequenced in T2c-iv-b and T2c-vi-a. |
