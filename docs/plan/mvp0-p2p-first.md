...
T7local, T7c, and MVP0-P2P DEV-HANDOFF are satisfied, so it is based on implemented surfaces
...
> **P6 closure — 2026-09-25:** P6.T0–T3 are PASS. T3.D Android visual
> certification closed on the `fenix_t7` AVD (`emulator-5554`,
