...
| E | T4 pilot, then T5 | **T4 implemented 2026-08-06** (RRI 51 Med-high; ADR-038 routed `CLOUD_REQUIRED` on both Qwen27 refinement and the primary receipt; implemented by Claude Code). T5 remains open pending the 30-day live pilot window defined in `docs/evaluations/antares-t4-calibration-report.md`. | existing slice gates |
