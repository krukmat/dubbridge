...
| **S-140** | Subtitle generation | S-130 | 🟡 plan/task ledger authored 2026-07-20 (status `proposed`) — canonical plan and task list drafted under ADR-037 Local Architect workflow; implementation not started | `docs/plan/s-140-subtitle-generation.md`, `docs/tasks/s-140-subtitle-generation.md` |
