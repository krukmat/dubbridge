...
| **S-150** | Translation + dubbing (TTS / voice cloning) | S-140, S-110 consent precondition | 🟡 planned 2026-08-02 — T0, T1a, and T1b complete; ratified slice boundaries now have matching product-code domain types plus the verified migration layer for the four S-150 artifact kinds and per-localization translation/dubbing statuses. Repository, queue, worker, and TTS/runtime work remain pending; T8 still tracks non-blocking future voice-consent hardening. | `docs/plan/s-150-translation-dubbing.md`, `docs/tasks/s-150-translation-dubbing.md`, `workers/translation-worker-py`, `workers/tts-worker-py` |
