...
| **S-140** | Subtitle generation | S-130 | 🟡 in progress — T0/T1a/T1b-i/T1b-ii/T1c/T1d/T2a/T2b-i done (2026-07-22: T2b-i transcription-ready enqueue extraction seam + atomic-claim race fix, D14-clean); T2b-ii/T3a/T3b/T5a/T6 remain | `docs/plan/s-140-subtitle-generation.md`, `docs/tasks/s-140-subtitle-generation.md` |
