...
| **S-140** | Subtitle generation | S-130 | 🟡 in progress — T0/T1a/T1b-i/T1b-ii/T1c/T1d/T2a/T2b-i/T2b-ii done (2026-07-22: T2b-i extraction seam + transcription atomic-claim race fix; T2b-ii direct subtitle enqueue hook, deterministic first-target routing, subtitle atomic claim, and worker-runner refactor that reduced `main.rs` to a 44-line startup entrypoint); T3a/T3b/T5a/T6 remain | `docs/plan/s-140-subtitle-generation.md`, `docs/tasks/s-140-subtitle-generation.md` |
