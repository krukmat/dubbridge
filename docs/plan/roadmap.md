...
| **S-140** | Subtitle generation | S-130 | 🟡 in progress — T0/T1a/T1b-i/T1b-ii/T1c/T1d/T2a/T2b-i/T2b-ii/T3a/T3b/T3c-i/T3c-ii/T3c-iii/T5a/T6 complete; canonical BDD + roadmap/plan/task sync landed 2026-07-30, and T5a is merged to `main` via `620d675`. `T3c-ii` closed via owner-waived phase-2 review; `T3c-iii` closed 2026-07-30 with explicit Redis CI gating and review evidence; `T3c-iv` remains deferred and `X-S-160-3` still needs explicit artifact-identity schema work | `docs/plan/s-140-subtitle-generation.md`, `docs/tasks/s-140-subtitle-generation.md` |
...
- **ADR candidates for product-layer phases (X22/X23/X24).** These are now all closed:
  ...
  - **X-S-160-3:** open — S-140 now creates review tasks from real subtitle readiness, but `review_tasks` still carries only `(project_id, asset_id, target_language_id)` and not the derived-artifact identity/version. Gate: explicit schema follow-up (`S-140-T5b` or later S-150-scoped work).
