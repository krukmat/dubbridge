...
| T6p-c | Local P2P deployment-contract evidence | operational/evidence | `infra/production/p2p/preflight.sh`; `scripts/test-production-images.sh` availability case; evidence/status docs | T6p-b PASS | [~] IN PROGRESS 2026-09-26 — RRI 70 Complex; harness + structural checks ready, local Docker runtime evidence pending |
