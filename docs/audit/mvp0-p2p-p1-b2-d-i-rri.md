---
type: Audit
title: "P1.B2.d-i — RRI report"
date: 2026-08-31
task: MVP0-P2P-P1-B2-D-I
---

# P1.B2.d-i — RRI report

## Command

```bash
python3 scripts/rri.py --platform rn --cc 1 --touches mobile/src/p2p/proof/replication-evidence.ts --touches mobile/__tests__/p2p/replication-evidence.test.ts --D 2 --T 2 --A 0 --K 0 --P 2 --X 2
```
