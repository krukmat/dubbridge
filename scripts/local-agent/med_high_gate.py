...
def validate_refinement_artifact(
    ...
    *,
    ...
    """Validate the Qwen27 med-high-refinement-v1 artifact in isolation.
...
def evaluate_route(
    *,
    ...
    - GATE-1: Qwen27 GO_LOCAL plus a matching primary GO_LOCAL receipt is
      eligible for local implementation.
    ...
    if architect_route == ROUTE_CLOUD_REQUIRED:
        return GateDecision(
            ...
            reason="Qwen27 recommended CLOUD_REQUIRED; the primary cannot upgrade this to local.",
        )
    ...
    return GateDecision(route=ROUTE_GO_LOCAL, reason="Qwen27 and primary both recommend GO_LOCAL.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--refinement-artifact", required=True, help="Path to the Qwen27 refinement artifact JSON.")
