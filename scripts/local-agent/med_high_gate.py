...
# moved from qwen3.6:27b-q4_K_M to Qwen3.6 27B.
REQUIRED_MODEL_TAG = "qwen3.6:27b-q4_K_M"
MED_HIGH_RRI_MIN = 41
MED_HIGH_RRI_MAX = 55
...
def validate_refinement_artifact(
    ...
    *,
    ...
    """Validate the Qwen3.6 27B med-high-refinement-v1 artifact in isolation.
...
def evaluate_route(
    *,
    ...
    - GATE-1: Qwen3.6 27B GO_LOCAL plus a matching primary GO_LOCAL receipt
    ...
    if architect_route == ROUTE_CLOUD_REQUIRED:
        return GateDecision(
            ...
            reason="Qwen3.6 27B recommended CLOUD_REQUIRED; the primary cannot upgrade this to local.",
        )
    ...
    return GateDecision(route=ROUTE_GO_LOCAL, reason="Qwen3.6 27B and primary both recommend GO_LOCAL.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--refinement-artifact", required=True, help="Path to the Qwen3.6 27B refinement artifact JSON.")
