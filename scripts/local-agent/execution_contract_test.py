...
class ExecutionContractTest(unittest.TestCase):
    def test_local_contract_has_runtime_preset_without_priority(self):
        card = SimpleNamespace(task_id="t1", card_id="card-t1", schema_version=2, source_schema="task-card-v2", rri=30, band="Moderate", policy_version="rri-v2")
    ...
    def test_cloud_contract_has_no_local_runtime_preset(self):
        card = SimpleNamespace(task_id="t2", card_id="card-t2", schema_version=2, source_schema="task-card-v2", rri=50, band="Med-high")
    ...
    def test_policy_version_defaults_to_rri_v2(self):
        card = SimpleNamespace(task_id="t3", card_id="card-t3", schema_version=2, source_schema="task-card-v2", rri=20, band="Low", policy_version=None)
